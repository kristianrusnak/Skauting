...
if($_SESSION['position_id'] == 2){
    echo '<a href="../pages/groups.php" class="menuContainerLink">
    ...
    echo '<div id="menuContainerLinkAdditional4" class="menuContainerLink">
            ...
            <div id="additionalMenu4">
                <a href="../pages/groups.php" class="additionalMenu4Linker">
...
echo    '<a class="menuContainerLink">
        ...
        <a href="../pages/user.php" class="menuContainerLink" id="userLink">
